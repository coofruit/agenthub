/**
 * SHA-256 hex digest for file uploads.
 * Uses Web Crypto when available (HTTPS / localhost); falls back to pure JS on HTTP.
 */
(function (global) {
  ...
  global.sha256Hex = async function sha256Hex(buffer) {
